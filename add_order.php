...
<head>
    ...
    <style>
        ...
        option {
            color: #000; /* ให้ dropdown options อ่านง่าย */
        }
            ...
            <div class="col-md-8 col-lg-7">
                ...
                <div class="card shadow-lg border-0 rounded-4">
                    ...
                    <div class="card-header text-center py-3">
                        <h2 class="mb-0 fw-bold"><i class="bi bi-journal-plus me-2"></i>Add Order</h2>
                    </div>
                    ...
                    <div class="card-body p-4 p-md-5">
                        <form action="php/insert_order.php" method="post">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg" name="order_id" id="order_id" placeholder="ORD001" required>
                            </div>
                                ...
                                <select name="model_id" id="model_id" class="form-select form-select-lg" required>
                                    ...
                                    <?php
                                        ...
                                        while($order = mysqli_fetch_assoc($orders)){
                                            echo "<option value='{$order['model_id']}'>{$order['model_name']}</option>";
                                        }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="buyer_country_id" id="buyer_country_id" class="form-select form-select-lg" required>
                                    <option value="" disabled selected>-- Select Buyer Country --</option>
                                    <?php
                                        ...
                                        while($bcountry = mysqli_fetch_assoc($bcountries)){
                                            echo "<option value='{$bcountry['country_id']}'>{$bcountry['country_name']}</option>";
                                        }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="seller_country_id" id="seller_country_id" class="form-select form-select-lg" required>
                                    <option value="" disabled selected>-- Select Seller Country --</option>
                                    <?php
                                        ...
                                        while($scountry = mysqli_fetch_assoc($scountries)){
                                            echo "<option value='{$scountry['country_id']}'>{$scountry['country_name']}</option>";
                                        }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg" name="responsible_agency" id="responsible_agency" placeholder="Royal Thai Army" required>
                            </div>

                            <div class="mb-4">
                                <label for="quantity" class="form-label fw-bold">Quantity</label>
                                <input type="text" class="form-control form-control-lg" name="quantity" id="quantity" placeholder="16" required>
                            </div>
